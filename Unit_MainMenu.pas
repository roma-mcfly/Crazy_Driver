...
procedure TForm_MainMenu.ImgGarageClick(Sender: TObject);
begin
  sndPlaySound('Music\SoundClick.wav', SND_NODEFAULT Or SND_ASYNC);
  Form_Garage.Show;
  Form_MainMenu.Hide;
...
begin
  ...
  Form_MainMenu.Close;
  Form_MainMenu.ImgClickEasyOff.Visible := true;
  Form_MainMenu.ImgClickNormalOff.Visible := true;
  Form_MainMenu.ImgClickHardOff.Visible := true;
  Form_Garage.ImgClick1Off.Visible := true;
  Form_Garage.ImgClick2Off.Visible := true;
  Form_Garage.ImgClick3Off.Visible := true;
  Form_Location.ImgClick1Off.Visible := true;
  Form_Location.ImgClick2Off.Visible := true;
  Form_Location.ImgClick3Off.Visible := true;
  Form_MainMenu.ImgClickEasyOn.Visible := false;
  Form_MainMenu.ImgClickNormalOn.Visible := false;
  Form_MainMenu.ImgClickHardOn.Visible := false;
  Form_Garage.ImgClick1On.Visible := false;
  Form_Garage.ImgClick2On.Visible := false;
  Form_Garage.ImgClick3On.Visible := false;
  Form_Garage.ImgBugatti.Visible := false;
  Form_Garage.ImgCitroen.Visible := false;
  Form_Garage.ImgDelorean.Visible := false;
  Form_Location.ImgClick1On.Visible := false;
  Form_Location.ImgClick2On.Visible := false;
  Form_Location.ImgClick3On.Visible := false;
  Form_Location.ImgDesert.Visible := false;
  Form_Location.ImgSavannah.Visible := false;
  Form_Location.ImgBelarus.Visible := false;
